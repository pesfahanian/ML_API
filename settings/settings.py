...
ACCEPTABLE_FILE_SUFFIXES = os.environ.get('ACCEPTABLE_FILE_SUFFIXES',
                                          ['jpg', 'jpeg', 'png'])
ACCEPTABLE_FILE_FORMATS = os.environ.get('ACCEPTABLE_FILE_FORMATS',
...
if DEVELOP_MODE:
    POSTGRES_DATABASE_PASSWORD = config_object['Database'][
...
if REDIS_PASSWORD:
    if not REDIS_HOST_ENV:
        ...
        REDIS_HOST = f"redis://:{REDIS_PASSWORD}@\
                        {REDIS_HOST_ENV.split('redis://')[1]}"
